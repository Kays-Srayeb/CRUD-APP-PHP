...
if (isset($_POST["submit"])) {
  ...
  $sql = "insert into users values('','$f_name','$l_name','$email','$gender')";
    ...
    <form method="post" style="width: 50vw; min-width: 300px" class="needs-validation g-3 was-validated">
      <div class="row">
        <div class="col">
          ...
          <input type="text" name="f_name" placeholder="Albert" class="form-control mb-2" required />
          <div class="valid-feedback ">Look Good!</div>
          <div class="invalid-feedback ">Please Enter Your First Name</div>
        </div>
        <div class="col">
          <label for="l_name" class="form-label">Last Name : </label>
          <input type="text" name="l_name" class="form-control mb-2" placeholder="Einstien" required />
          <div class="valid-feedback ">Look Good!</div>
      ...
      <div class="mt-3 mb-3">
        ...
        <input type="email" name="email" class="form-control mb-2" placeholder="Albert@abc.xyz" required />
        <div class="valid-feedback ">Look Good!</div>
